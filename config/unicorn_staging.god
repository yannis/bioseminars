RAILS_ROOT = "/var/www/bioseminars_staging/current"

God.watch do |w|
  pid_file = File.join(RAILS_ROOT, "tmp/pids/bioseminars_staging_unicorn.pid")

  w.name = "bioseminars_staging_unicorn"
