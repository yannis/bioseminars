APPLICATION_NAME = 'bioseminars_staging'
...
# APP_PATH = '/Users/yannis/railsapps/bioseminars_staging/current'
# APP_PATH = "/u/apps/#{APPLICATION_NAME}/current" if %w[staging staging].include?(RAILS_ENV)
...
Eye.application APPLICATION_NAME do
  ...
  process :unicorn do
    pid_file "tmp/pids/bioseminars_staging_unicorn.pid"
