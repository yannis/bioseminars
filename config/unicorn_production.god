RAILS_ROOT = "/var/www/bioseminars_production/current"

God.watch do |w|
  pid_file = File.join(RAILS_ROOT, "tmp/pids/bioseminars_production_unicorn.pid")

  w.name = "bioseminars_production_unicorn"
  w.interval = 60.seconds
  w.start = "cd #{RAILS_ROOT} && bundle exec unicorn -c #{RAILS_ROOT}/config/unicorn_production.rb -E production -D"
